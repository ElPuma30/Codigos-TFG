...
with open("salida.txt", "w") as archivo:
    # Redirige la salida estandar al archivo
    sys.stdout = archivo  
    # Fijamos la trayectoria a analizar
    trajectory = trajectory_TEST

    # Obtenemos las soluciones analiticas para cada waypoint
    ...
    # Refinamos las soluciones numericamente (True/False)
    ...
    # Determinamos la mejor cadena para cada solucion inicial
